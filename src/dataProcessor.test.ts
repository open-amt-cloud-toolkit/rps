...
describe('process client data', () => {
  ...
  it('process data to call heartbeat', async () => {
    const clientMsg = '{"apiKey":"key","appVersion":"1.2.0","message":"all\'s good!","method":"unknown","payload":"","protocolVersion":"2.0.0","status":"ok"}'
    const clientId = uuid()
    devices[clientId] = { ClientId: clientId, ClientSocket: null, unauthCount: 0 }
    VersionChecker.setCurrentVersion('2.0.0')
    const ret = {
      method: ClientMethods.HEARTBEAT
    }
    const clientMethodsparseClientMsg = jest.spyOn(dataProcessor.validator, 'parseClientMsg').mockReturnValue(ret)
    jest.spyOn(dataProcessor, 'heartbeat').mockReturnValue(null)
    await dataProcessor.processData(clientMsg, clientId)
    expect(clientMethodsparseClientMsg).toHaveBeenCalledTimes(4)
  })

  it('process data to call maintain Device', async () => {
    const clientMsg = '{"apiKey":"key","appVersion":"1.2.0","message":"all\'s good!","method":"unknown","payload":"","protocolVersion":"2.0.0","status":"ok"}'
    const clientId = uuid()
    devices[clientId] = { ClientId: clientId, ClientSocket: null, unauthCount: 0 }
    VersionChecker.setCurrentVersion('2.0.0')
    ...
    const clientMethodshandlemaintainDevice = jest.spyOn(dataProcessor.validator, 'parseClientMsg').mockReturnValue(ret)
    await dataProcessor.processData(clientMsg, clientId)
    expect(clientMethodshandlemaintainDevice).toHaveBeenCalledTimes(5)
  })
})

describe('deactivate Device', () => {
  it('should return client message with deactivation WSMan as payload', async () => {
    ...
    const responseMsg = await dataProcessor.deactivateDevice(clientMsg, clientId)
    expect(validatorSpy).toHaveBeenCalled()
    expect(responseMsg.method).toContain('wsman')
  })

  it('should return client message with deactivation WSMan as payload on 401 response', async () => {
    const buildResponseSpy = jest.spyOn(dataProcessor.clientActions, 'buildResponseMessage').mockImplementation(async () => {
      return {
        method: 'wsman',
        apiKey: 'xxxxx',
        appVersion: '1.2.0',
...
describe('activate Device', () => {
  it('activate in acm', async () => {
    ...
    devices[clientId] = { ClientId: clientId, activationStatus: ActivationStatus, action: ClientAction.ADMINCTLMODE, ClientSocket: null, ClientData: clientData, messageId: 2, connectionParams: connectionParams, unauthCount: 0 }
  ...
  it('activate in ccm', async () => {
    ...
    devices[clientId] = { ClientId: clientId, activationStatus: ActivationStatus, action: ClientAction.CLIENTCTLMODE, ClientSocket: null, ClientData: clientData, messageId: 2, connectionParams: connectionParams, unauthCount: 0 }
    const validatorSpy = jest.spyOn(dataProcessor.validator, 'validateActivationMsg').mockImplementation(async () => {})
    jest.spyOn(dataProcessor, 'setConnectionParams').mockImplementation()
    jest.spyOn(dataProcessor.amt, 'GeneralSettings').mockImplementation()
    jest.spyOn(dataProcessor.httpHandler, 'wrapIt').mockImplementation().mockReturnValue('abcdef')
