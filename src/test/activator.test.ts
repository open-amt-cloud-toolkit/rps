...
describe('processWSManJasonResponse', async () => {
...
describe('waitForActivation', async () => {
...
describe('setMEBxPassword', async () => {
...
describe('injectCertificate', async () => {
