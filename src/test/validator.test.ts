...
describe('Activation message', () => {
  ...
  test.skip('should throw an exception if the activition is null for a profile', async () => {
    let rpsError = null
    try {
      const clientId = uuid()
      clientManager.addClient({ ClientId: clientId, ClientSocket: null })
...
describe('Activation message for admin control mode', () => {
  ...
  test.skip('should not throw an exception given all the information in the admin control activation message', async () => {
    const msg = '{"apiKey":"key","appVersion":"1.2.0","message":"all\'s good!","method":"activation","payload":"","protocolVersion":"4.0.0","status":"ok"}'
    const clientId = uuid()
    clientManager.addClient({ ClientId: clientId, ClientSocket: null })
    const clientMsg = validator.parseClientMsg(msg, clientId)
  ...
  test.skip('should throw an exception `Missing DNS Suffix` when payload does not contain DNS suffix and the activation is `acmactivate`', async () => {
    let rpsError = null
    try {
      const clientId = uuid()
      clientManager.addClient({ ClientId: clientId, ClientSocket: null })
  ...
  test.skip('should throw an exception when DNS suffix does not exist in the list of available domain suffix and the activation is `acmactivate`', async () => {
    let rpsError = null
    try {
      const clientId = uuid()
      clientManager.addClient({ ClientId: clientId, ClientSocket: null })
  ...
  test.skip('should throw an exception when certificate hashes are missing in payload and the activation is `acmactivate`', async () => {
    let rpsError = null
    try {
      const clientId = uuid()
      clientManager.addClient({ ClientId: clientId, ClientSocket: null })
